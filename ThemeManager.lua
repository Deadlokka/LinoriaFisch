...
local ThemeManager = {} do
	ThemeManager.Folder = 'LinoriaLibrary Settings'

	ThemeManager.Library = nil
	ThemeManager.BuiltInThemes = {
		['Default'] 		= { 1, httpService:JSONDecode('{"FontColor":"cecece","MainColor":"1d1d24","AccentColor":"ff54ff","BackgroundColor":"1a1d22","OutlineColor":"4f6363"}') },
    ...
    groupbox:AddLabel('Accent color'):AddColorPicker('AccentColor', { Default = self.Library.AccentColor });
		...
		groupbox:AddButton('Make it default', function()
		...
		groupbox:AddInput('ThemeManager_CustomThemeName', { Text = 'Custom your theme name' })
